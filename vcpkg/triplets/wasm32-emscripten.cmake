...
set(ENV{CFLAGS} "-pthread -matomics -mbulk-memory -s USE_PTHREADS=1")
set(ENV{CXXFLAGS} "-pthread -matomics -mbulk-memory -s USE_PTHREADS=1")
set(ENV{LDFLAGS} "-pthread -s USE_PTHREADS=1 -s SHARED_MEMORY=1")